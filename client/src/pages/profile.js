...
function Profile({ user, setUser }) {
    ...
    return (
        <div className="grid grid-cols-3 gap-4">
            {user && (
                <>
                    <div className="shadow-xl bg-red-linen rounded-lg h-150 p-2 my-2">
                        <Avatar user={user} size="200px" />
                    ...
                    <div className="shadow-xl bg-red-linen rounded-lg h-18 p-2 my-2 px-2 h-150 overflow-y-scroll scrollbar-thin scrollbar-thumb-red-eggplant scrollbar-track-red-linen col-start-2 col-end-4">
